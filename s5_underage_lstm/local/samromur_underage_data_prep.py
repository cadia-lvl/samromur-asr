#-*- coding: utf-8 -*- 
########################################################################
#samromur_underage_data_prep.py
...
#	$ python3 samromur_underage_data_prep.py <samromur_children_directory>

#Specific example:

#	$ python3 samromur_underage_data_prep.py /mnt/Datos/CORPUS/samromur_children_ldc

#Description:

#This script is part of Kaldi recipe.

#In this recipe only children from 4 to 17 years are considered.
