...
# Path to text corpus. Used to create the 
...
# Path to the local dir in the repo https://github.com/aalto-speech/subword-kaldi.git
...
echo ============================================================================
    ...
    #         --pruning "0" \
    #         --carpa true \
    #         $corpus_dir/bpe/${tag}_subset \
    #         $data/lang/${tag}_8g \
    #         $data/dict/$tag/lexicon.txt \
    #         $data/lm/${tag}_${lm_order}g_rescoring > "$log/$method/${tag}_lm_${lm_order}g_rescoring.log"
fi
...
echo ============================================================================
    run_aalto/tdnn_decode.sh --stage 0 \
        --decoding-lang $data/lm/${tag}_6g \
        --rescoring-lang $data/lm/${tag}_rescoring \
